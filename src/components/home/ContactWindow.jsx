...
import Contact from "./navbar-window/Contact";

const ContactWindow = ({ showContact, isContactFullscreen, setIsContactFullscreen, setShowContact, windowVariants }) => {
  return (
    <AnimatePresence>
      {showContact && (
        <motion.div
        ...
        >
          ...
          <div className="flex justify-between items-center bg-gray-100 dark:bg-[#252530] p-3 rounded-t-md border-b border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-600 dark:text-gray-400 text-sm ml-2">Contact</span>
            </div>
            <div className="flex gap-2">
              <motion.button
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                onClick={() => setIsContactFullscreen(!isContactFullscreen)}
